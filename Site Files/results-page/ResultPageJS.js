...
function setLocalImpacts(){
    if (country == "US" && county.length > 2){
        console.log("tkeljfoiasodjflskjfapofjpoijsfoipjdoifajspoifsoipjfpoismexico")
    }
    ...
    element = document.getElementById("ImpactPhoto" + (k + 1));
            ...
            console.log(data["local impacts"][k]["img"]["file"])
        if (data["local impacts"][k]["img"]["file"] == null || data["local impacts"][k]["img"]["file"] == ""){
    ...
    if (data["local impacts"][k]["img"]["caption"] == null ){
            element.style.display = "none";
        }
        else {
