...
def main(fileLocation,name):
    ...
    #sets name
    with open(fileLocation+'.json', "w") as myfile:
...
def updateMetadata(resourceID,resourceType,width=None,height=None,startYear=None,endYear=None,dataSource=None,dataSourceLink=None):
